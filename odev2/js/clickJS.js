$(document).ready(function(){
    ...
    function createDivElement(){
        setTimeout(function(){
            if(isDarkMode){
                divElementDark = '<div style="' + getRandomSize() + getRandomPosition() +  getRandomColor() + ' border: 2px solid white; border-radius: 45px"></div>';
                $("body").append(divElementDark);
            }
            else{
                divElementWhite = '<div style="' + getRandomSize() + getRandomPosition() +  getRandomColor() + ' border: 2px solid black; border-radius: 45px"></div>';
